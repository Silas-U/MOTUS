...
#     - rest-to-rest per leg
#     - velocity/acceleration continuity across legs is a future extension
# """
...
#             # ==========================================================
#             # We need live state only for leg 0
#             # ==========================================================
...
#             # ==========================================================
#             # Ensure stale prefetch cannot leak between action goals
#             # ==========================================================
...
#                     self.get_logger().warn(
#                         f"[arm_executor] goal cancelled before "
#                         f"leg '{leg.step_id}'"
#                     )
...
#                 #
#                 # Leg 0:
#                 #     plan synchronously on planning worker.
#                 #
#                 # Leg N:
#                 #     consume prefetched plan.
#                 # ------------------------------------------------------
...
#                 if (
#                     self._next_plan is not None
#                     and self._next_plan_step_id == leg.step_id
#                 ):

#                     self.get_logger().debug(
#                         f"[arm_executor] consuming prefetched "
#                         f"plan '{leg.step_id}'"
#                     )

#                     plan_future = self._next_plan
...
#                         self.get_logger().error(
#                             f"[arm_executor] prefetched planning"
#                             f"failed for '{leg.step_id}': {exc}"
#                         )
...
#                     # No prefetched plan.
#                     #
#                     # Normally this happens only for leg 0.
#                     # --------------------------------------------------

#                     plan_start = time.monotonic()

#                     self.get_logger().debug(
#                         f"[arm_executor] planning leg "
#                         f"'{leg.step_id}' synchronously"
#                     )
...
#                         self.get_logger().error(
#                             f"[arm_executor] planning exception for "
#                             f"'{leg.step_id}': {exc}"
#                         )
...
#                     self.get_logger().error(
#                         f"[arm_executor] no trajectory produced for "
#                         f"'{leg.step_id}'"
#                     )
...
#                 # ------------------------------------------------------
#                 # Prefetch NEXT leg BEFORE starting current execution.
#                 #
#                 # IMPORTANT:
#                 #
#                 #     planned.predicted_q
...
#                     self.get_logger().debug(
#                         f"[arm_executor] prefetching next leg "
#                         f"'{next_leg.step_id}' from predicted_q"
#                     )
...
#                     self.get_logger().error(
#                         f"[arm_executor] execution failed for "
#                         f"'{leg.step_id}'"
#                     )
...
#                 # IMPORTANT:
#                 #
#                 # Advance planner seed from the trajectory prediction,
#                 # not live feedback.
#                 # ------------------------------------------------------
...
#                         current_step_id=leg.step_id,
#                         percent_complete=1.0,
#                     )
#                 )

#                 self.get_logger().info(
#                     f"[arm_executor] completed leg "
#                     f"'{leg.step_id}' "
#                     f"({i + 1}/{total_legs})"
#                 )
