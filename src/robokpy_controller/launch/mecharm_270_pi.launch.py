...
def generate_launch_description():
    ...
    controllers_yaml_path = os.path.join(pkg, 'config', 'mecharm_270_pi.yaml')
    rviz_config           = os.path.join(pkg, 'config',  'config.rviz')
    robokpy_config_yaml_path = os.path.join(pkg, 'config', 'robokpy_configs_mecharm.yaml')
    ...
    urdf_real_file = os.path.join(pkg, 'urdf', 'mecharm_270_pi_virtual.urdf')
    urdf_sim_file  = os.path.join(pkg, 'urdf', 'mecharm_270_pi_sim.urdf')
    ...
    gz_urdf_file = os.path.join(tempfile.gettempdir(), 'mecharm_270_pi.urdf')
