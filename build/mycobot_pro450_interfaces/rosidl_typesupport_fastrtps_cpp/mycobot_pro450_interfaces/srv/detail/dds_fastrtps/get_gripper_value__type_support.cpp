  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_pro450_interfaces::srv::GetGripperValue_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_key_GetGripperValue_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetGripperValue_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetGripperValue_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mycobot_pro450_interfaces::srv::GetGripperValue_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_key_GetGripperValue_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetGripperValue_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetGripperValue_Response(full_bounded, is_plain, 0);
...
// functions for mycobot_pro450_interfaces::srv::GetGripperValue_Request already declared above

// functions for mycobot_pro450_interfaces::srv::GetGripperValue_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
cdr_serialize(
  const mycobot_pro450_interfaces::srv::GetGripperValue_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mycobot_pro450_interfaces::srv::GetGripperValue_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_GetGripperValue_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_pro450_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetGripperValue_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_pro450_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetGripperValue_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mycobot_pro450_interfaces::srv::GetGripperValue_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_key_GetGripperValue_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_pro450_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetGripperValue_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_pro450_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetGripperValue_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mycobot_pro450_interfaces::srv::GetGripperValue_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mycobot_pro450_interfaces::srv::GetGripperValue_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetGripperValue_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mycobot_pro450_interfaces::srv::GetGripperValue_Event *>(
...
static size_t _GetGripperValue_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetGripperValue_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetGripperValue_Event__callbacks = {
  "mycobot_pro450_interfaces::srv",
...
static rosidl_message_type_support_t _GetGripperValue_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetGripperValue_Event__callbacks,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mycobot_pro450_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mycobot_pro450_interfaces::srv::GetGripperValue_Event>()
{
  return &mycobot_pro450_interfaces::srv::typesupport_fastrtps_cpp::_GetGripperValue_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_pro450_interfaces, srv, GetGripperValue_Event)() {
  return &mycobot_pro450_interfaces::srv::typesupport_fastrtps_cpp::_GetGripperValue_Event__handle;
}
...
static const rosidl_service_type_support_t _GetGripperValue__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetGripperValue__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mycobot_pro450_interfaces::srv::GetGripperValue_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mycobot_pro450_interfaces::srv::GetGripperValue_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mycobot_pro450_interfaces::srv::GetGripperValue_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<mycobot_pro450_interfaces::srv::GetGripperValue>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<mycobot_pro450_interfaces::srv::GetGripperValue>,
