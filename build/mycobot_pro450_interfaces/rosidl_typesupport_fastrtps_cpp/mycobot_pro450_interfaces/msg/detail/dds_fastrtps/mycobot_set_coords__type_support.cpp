...
#include "mycobot_pro450_interfaces/msg/detail/mycobot_set_coords__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mycobot_pro450_interfaces::msg::MycobotSetCoords & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mycobot_pro450_interfaces::msg::MycobotSetCoords & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_pro450_interfaces::msg::MycobotSetCoords;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_key_MycobotSetCoords(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mycobot_pro450_interfaces::msg::MycobotSetCoords *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mycobot_pro450_interfaces::msg::MycobotSetCoords *>(
    untyped_ros_message);
...
{
  return &mycobot_pro450_interfaces::msg::typesupport_fastrtps_cpp::_MycobotSetCoords__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_pro450_interfaces, msg, MycobotSetCoords)() {
  return &mycobot_pro450_interfaces::msg::typesupport_fastrtps_cpp::_MycobotSetCoords__handle;
}
