...
#include "mycobot_pro450_interfaces/msg/detail/mycobot_angles__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mycobot_pro450_interfaces::msg::MycobotAngles & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mycobot_pro450_interfaces::msg::MycobotAngles & ros_message)
{
  // Member: joint_1
  cdr >> ros_message.joint_1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_pro450_interfaces::msg::MycobotAngles;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_key_MycobotAngles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mycobot_pro450_interfaces::msg::MycobotAngles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mycobot_pro450_interfaces::msg::MycobotAngles *>(
    untyped_ros_message);
...
get_message_type_support_handle<mycobot_pro450_interfaces::msg::MycobotAngles>()
{
  return &mycobot_pro450_interfaces::msg::typesupport_fastrtps_cpp::_MycobotAngles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_pro450_interfaces, msg, MycobotAngles)() {
  return &mycobot_pro450_interfaces::msg::typesupport_fastrtps_cpp::_MycobotAngles__handle;
}
