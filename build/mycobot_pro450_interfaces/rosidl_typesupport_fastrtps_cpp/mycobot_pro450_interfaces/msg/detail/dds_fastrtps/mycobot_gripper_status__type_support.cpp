...
#include "mycobot_pro450_interfaces/msg/detail/mycobot_gripper_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mycobot_pro450_interfaces::msg::MycobotGripperStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mycobot_pro450_interfaces::msg::MycobotGripperStatus & ros_message)
{
  // Member: status
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_pro450_interfaces::msg::MycobotGripperStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_pro450_interfaces
max_serialized_size_key_MycobotGripperStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mycobot_pro450_interfaces::msg::MycobotGripperStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mycobot_pro450_interfaces::msg::MycobotGripperStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<mycobot_pro450_interfaces::msg::MycobotGripperStatus>()
{
  return &mycobot_pro450_interfaces::msg::typesupport_fastrtps_cpp::_MycobotGripperStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_pro450_interfaces, msg, MycobotGripperStatus)() {
  return &mycobot_pro450_interfaces::msg::typesupport_fastrtps_cpp::_MycobotGripperStatus__handle;
}
