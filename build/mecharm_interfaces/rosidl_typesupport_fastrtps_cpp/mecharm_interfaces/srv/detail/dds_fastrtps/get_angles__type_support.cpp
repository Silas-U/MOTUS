...
#include "mecharm_interfaces/srv/detail/get_angles__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecharm_interfaces::srv::GetAngles_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mecharm_interfaces::srv::GetAngles_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mecharm_interfaces::srv::GetAngles_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<mecharm_interfaces::srv::GetAngles_Request>()
{
  return &mecharm_interfaces::srv::typesupport_fastrtps_cpp::_GetAngles_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mecharm_interfaces::srv::GetAngles_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mecharm_interfaces::srv::GetAngles_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mecharm_interfaces::srv::GetAngles_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mecharm_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mecharm_interfaces::srv::GetAngles_Response>()
{
  return &mecharm_interfaces::srv::typesupport_fastrtps_cpp::_GetAngles_Response__handle;
}
...
// functions for mecharm_interfaces::srv::GetAngles_Request already declared above

// functions for mecharm_interfaces::srv::GetAngles_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecharm_interfaces
cdr_serialize(
  const mecharm_interfaces::srv::GetAngles_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecharm_interfaces::srv::GetAngles_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecharm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetAngles_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecharm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetAngles_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mecharm_interfaces::srv::GetAngles_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecharm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetAngles_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecharm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetAngles_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mecharm_interfaces::srv::GetAngles_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mecharm_interfaces::srv::GetAngles_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mecharm_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mecharm_interfaces::srv::GetAngles_Event>()
{
  return &mecharm_interfaces::srv::typesupport_fastrtps_cpp::_GetAngles_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecharm_interfaces, srv, GetAngles_Event)() {
  return &mecharm_interfaces::srv::typesupport_fastrtps_cpp::_GetAngles_Event__handle;
}
...
static const rosidl_service_type_support_t _GetAngles__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mecharm_interfaces::srv::GetAngles_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mecharm_interfaces::srv::GetAngles_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mecharm_interfaces::srv::GetAngles_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<mecharm_interfaces::srv::GetAngles>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<mecharm_interfaces::srv::GetAngles>,
...
get_service_type_support_handle<mecharm_interfaces::srv::GetAngles>()
{
  return &mecharm_interfaces::srv::typesupport_fastrtps_cpp::_GetAngles__handle;
}
