...
#include "mecharm_interfaces/msg/detail/mecharm_coords__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mecharm_interfaces::msg::MecharmCoords & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecharm_interfaces::msg::MecharmCoords & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecharm_interfaces
max_serialized_size_MecharmCoords(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecharm_interfaces::msg::MecharmCoords;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecharm_interfaces
max_serialized_size_key_MecharmCoords(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mecharm_interfaces::msg::MecharmCoords *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mecharm_interfaces::msg::MecharmCoords *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MecharmCoords__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mecharm_interfaces::msg::MecharmCoords *>(
...
static size_t _MecharmCoords__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MecharmCoords(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MecharmCoords__callbacks = {
...
static rosidl_message_type_support_t _MecharmCoords__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MecharmCoords__callbacks,
...
get_message_type_support_handle<mecharm_interfaces::msg::MecharmCoords>()
{
  return &mecharm_interfaces::msg::typesupport_fastrtps_cpp::_MecharmCoords__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecharm_interfaces, msg, MecharmCoords)() {
  return &mecharm_interfaces::msg::typesupport_fastrtps_cpp::_MecharmCoords__handle;
}
