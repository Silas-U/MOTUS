  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mypalletizer_interfaces::srv::GripperStatus_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mypalletizer_interfaces::srv::GripperStatus_Response;
    is_plain =
      (
...
// functions for mypalletizer_interfaces::srv::GripperStatus_Request already declared above

// functions for mypalletizer_interfaces::srv::GripperStatus_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mypalletizer_interfaces
cdr_serialize(
  const mypalletizer_interfaces::srv::GripperStatus_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mypalletizer_interfaces::srv::GripperStatus_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mypalletizer_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GripperStatus_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mypalletizer_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GripperStatus_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mypalletizer_interfaces::srv::GripperStatus_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mypalletizer_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GripperStatus_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mypalletizer_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GripperStatus_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mypalletizer_interfaces::srv::GripperStatus_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mypalletizer_interfaces::srv::GripperStatus_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mypalletizer_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mypalletizer_interfaces::srv::GripperStatus_Event>()
{
  return &mypalletizer_interfaces::srv::typesupport_fastrtps_cpp::_GripperStatus_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mypalletizer_interfaces, srv, GripperStatus_Event)() {
  return &mypalletizer_interfaces::srv::typesupport_fastrtps_cpp::_GripperStatus_Event__handle;
}
...
static const rosidl_service_type_support_t _GripperStatus__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mypalletizer_interfaces::srv::GripperStatus_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mypalletizer_interfaces::srv::GripperStatus_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mypalletizer_interfaces::srv::GripperStatus_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<mypalletizer_interfaces::srv::GripperStatus>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<mypalletizer_interfaces::srv::GripperStatus>,
