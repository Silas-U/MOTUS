...
#include "mypalletizer_interfaces/msg/detail/mypal_pump_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mypalletizer_interfaces::msg::MypalPumpStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mypalletizer_interfaces::msg::MypalPumpStatus & ros_message)
{
  // Member: status
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mypalletizer_interfaces
max_serialized_size_MypalPumpStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mypalletizer_interfaces::msg::MypalPumpStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mypalletizer_interfaces
max_serialized_size_key_MypalPumpStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mypalletizer_interfaces::msg::MypalPumpStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mypalletizer_interfaces::msg::MypalPumpStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MypalPumpStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mypalletizer_interfaces::msg::MypalPumpStatus *>(
...
static size_t _MypalPumpStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MypalPumpStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MypalPumpStatus__callbacks = {
...
static rosidl_message_type_support_t _MypalPumpStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MypalPumpStatus__callbacks,
...
{
  return &mypalletizer_interfaces::msg::typesupport_fastrtps_cpp::_MypalPumpStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mypalletizer_interfaces, msg, MypalPumpStatus)() {
  return &mypalletizer_interfaces::msg::typesupport_fastrtps_cpp::_MypalPumpStatus__handle;
}
