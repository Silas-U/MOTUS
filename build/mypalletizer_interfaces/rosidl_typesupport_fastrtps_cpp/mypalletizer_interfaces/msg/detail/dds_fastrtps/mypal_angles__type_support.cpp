...
#include "mypalletizer_interfaces/msg/detail/mypal_angles__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mypalletizer_interfaces::msg::MypalAngles & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mypalletizer_interfaces::msg::MypalAngles & ros_message)
{
  // Member: joint_1
  cdr >> ros_message.joint_1;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mypalletizer_interfaces
max_serialized_size_MypalAngles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mypalletizer_interfaces::msg::MypalAngles;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mypalletizer_interfaces
max_serialized_size_key_MypalAngles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mypalletizer_interfaces::msg::MypalAngles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mypalletizer_interfaces::msg::MypalAngles *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MypalAngles__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mypalletizer_interfaces::msg::MypalAngles *>(
...
static size_t _MypalAngles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MypalAngles(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MypalAngles__callbacks = {
...
static rosidl_message_type_support_t _MypalAngles__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MypalAngles__callbacks,
...
{
  return &mypalletizer_interfaces::msg::typesupport_fastrtps_cpp::_MypalAngles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mypalletizer_interfaces, msg, MypalAngles)() {
  return &mypalletizer_interfaces::msg::typesupport_fastrtps_cpp::_MypalAngles__handle;
}
