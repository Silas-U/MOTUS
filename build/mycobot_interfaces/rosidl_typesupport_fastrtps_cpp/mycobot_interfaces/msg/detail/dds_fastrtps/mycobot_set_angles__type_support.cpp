...
#include "mycobot_interfaces/msg/detail/mycobot_set_angles__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_interfaces::msg::MycobotSetAngles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mycobot_interfaces::msg::MycobotSetAngles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mycobot_interfaces::msg::MycobotSetAngles *>(
    untyped_ros_message);
...
get_message_type_support_handle<mycobot_interfaces::msg::MycobotSetAngles>()
{
  return &mycobot_interfaces::msg::typesupport_fastrtps_cpp::_MycobotSetAngles__handle;
}
