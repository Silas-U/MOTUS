...
- `launch/ur5e_test.launch.py` -- thin wrapper around robokpy_controller's
  `arm.launch.py`
...
```
colcon build --packages-select ur5e_test_motus
source install/setup.bash
ros2 launch ur5e_test_motus ur5e_test.launch.py use_sim:=true
```
