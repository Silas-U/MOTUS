...
#ifndef ROBOKPY_INTERFACES__SRV__DETAIL__RESOLVE_OBJECT_POSE__FUNCTIONS_H_
#define ROBOKPY_INTERFACES__SRV__DETAIL__RESOLVE_OBJECT_POSE__FUNCTIONS_H_
...
/// Initialize srv/ResolveObjectPose message.
/**
 ...
 * )) before or use
 * robokpy_interfaces__srv__ResolveObjectPose_Request__create()
...
/// Finalize srv/ResolveObjectPose message.
/**
...
/// Create srv/ResolveObjectPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robokpy_interfaces__srv__ResolveObjectPose_Request__init().
...
/// Destroy srv/ResolveObjectPose message.
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Request__fini()
...
/// Check for srv/ResolveObjectPose message equality.
/**
...
/// Copy a srv/ResolveObjectPose message.
/**
...
/// Initialize array of srv/ResolveObjectPose messages.
/**
...
/// Finalize array of srv/ResolveObjectPose messages.
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Request__fini()
...
/// Create array of srv/ResolveObjectPose messages.
/**
 * It allocates the memory for the array and calls
 * robokpy_interfaces__srv__ResolveObjectPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ResolveObjectPose messages.
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ResolveObjectPose message array equality.
/**
...
/// Copy an array of srv/ResolveObjectPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * robokpy_interfaces__srv__ResolveObjectPose_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robokpy_interfaces__srv__ResolveObjectPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
...
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robokpy_interfaces__srv__ResolveObjectPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
...
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * robokpy_interfaces__srv__ResolveObjectPose_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robokpy_interfaces__srv__ResolveObjectPose_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
...
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robokpy_interfaces__srv__ResolveObjectPose_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robokpy_interfaces
...
/**
 * It calls
 * robokpy_interfaces__srv__ResolveObjectPose_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOKPY_INTERFACES__SRV__DETAIL__RESOLVE_OBJECT_POSE__FUNCTIONS_H_
