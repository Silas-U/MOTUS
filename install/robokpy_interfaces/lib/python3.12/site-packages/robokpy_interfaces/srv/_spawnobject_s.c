...
bool robokpy_interfaces__srv__spawnobject__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robokpy_interfaces.srv._spawnobject.Spawnobject_Request", full_classname_dest, 55) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * robokpy_interfaces__srv__spawnobject__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Spawnobject_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robokpy_interfaces.srv._spawnobject");
...
ROSIDL_GENERATOR_C_EXPORT
bool robokpy_interfaces__srv__spawnobject__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robokpy_interfaces.srv._spawnobject.Spawnobject_Response", full_classname_dest, 56) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * robokpy_interfaces__srv__spawnobject__response__convert_to_py(void * raw_ros_message)
{
...
ROSIDL_GENERATOR_C_EXPORT
bool robokpy_interfaces__srv__spawnobject__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robokpy_interfaces.srv._spawnobject.Spawnobject_Event", full_classname_dest, 53) == 0);
  }
  ...
  {  // request
    ...
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!robokpy_interfaces__srv__spawnobject__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!robokpy_interfaces__srv__spawnobject__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * robokpy_interfaces__srv__spawnobject__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = robokpy_interfaces__srv__spawnobject__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = robokpy_interfaces__srv__spawnobject__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
