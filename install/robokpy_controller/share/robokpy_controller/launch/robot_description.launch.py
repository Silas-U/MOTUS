...
def generate_launch_description():
    ...
    controllers_yaml_path = os.path.join(pkg, 'config', 'mycobot_280_m5.yaml')
    rviz_config           = os.path.join(pkg, 'config',  'config.rviz')
    robokpy_config_yaml_path = os.path.join(pkg, 'config', 'robokpy_configs_mycobot.yaml')
    ...
    urdf_real_file = os.path.join(pkg, 'urdf', 'mycobot_280_m5_virtual.urdf')
    urdf_sim_file  = os.path.join(pkg, 'urdf', 'mycobot_280_m5_sim.urdf')
    ...
    gz_urdf_file = os.path.join(tempfile.gettempdir(), 'mycobot_280_m5.urdf')
